  ...
  <div class="container h-100 w-100 ">
    <div class="d-flex mt-5 h-100  w-100 text-sm-start  p-5 ">
      <div class="w-50 text-white">
        <p class=" mt-5 ps-5 " style="font-weight:800;font-size:20pt;">OUR PROJECTS </p>
      </div>
    </div>
  </div>
  <script>
      ...
      <div class="d-flex flex-column gap-3">
        <div class="d-flex flew-row gap-3">
          <div class="d-flex flew-row justify-content-center">
            <div class="container overflow-hidden"> <button name="submit1" class="overflow-hidden p-0 border-0 "><img
                  style="transition: all .8s ease-in-out;" src="images\Residential\projectimage\072.jpeg"
                  class="image-container" /></button>
              <div class="centered" style="font-weight:800;font-size:40pt;">Residential</div>
              </p>
            </div>
          </div>
          <div class="d-flex flew-row justify-content-center">
            <div class="container overflow-hidden"> <button name="submit2" class="overflow-hidden p-0 border-0 "><img
                  style="transition: all .8s ease-in-out;" src="images\industrial\projectimage\071.jpeg"
                  class="image-container" /></button>
              <div class="centered" style="font-weight:800;font-size:40pt;">industrial</div>
              </p>
            </div>
          </div>
        </div>
        <div class="d-flex flew-row justify-content-center">
          <div class="container overflow-hidden"> <button name="submit3" class="overflow-hidden p-0 border-0 "><img
                style="transition: all .8s ease-in-out;" src="images\Commercial\projectimage\076.jpeg"
                class="image-container" /></button>
            <div class="centered" style="font-weight:800;font-size:40pt;">Commercial</div>
            </p>
          </div>
        </div>
      </div>
